...
public class BolilleroF1 {
    private List<AutoF1> bolillero = new ArrayList<>();
    private Random random = new Random();
    
    public void agregarBolilla(AutoF1 auto) {
        if (auto == null) {
    ...
    public AutoF1 getBolillaReposicion() {
        verificarBolillero();
        
        return bolillero.get(getBolillaRandom());
    }
    
    public AutoF1 getBolillaSinReposicion() {
        verificarBolillero();
